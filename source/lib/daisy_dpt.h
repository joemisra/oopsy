...
namespace dpt
{
    ...
    class DPT
    {
      public:
        ...
        void InitTimer(daisy::dpt_internal::PeriodElapsedCallback cb, void *data);
        ...
        constexpr static Pin B5  = Pin(PORTC, 13); /**< B5  - GATE OUT 1 */
        constexpr static Pin B6  = Pin(PORTC, 14); /**< B6  - GATE OUT 2 */
